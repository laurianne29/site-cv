...
if (!empty($_POST['pseudo']) && !empty($_POST['mdp'])) {
	$query = $bdd -> prepare("INSERT INTO user (nom, prenom, email, tel, mdp, avatar, age, sexe, etat_civil, statut, adresse, code_postal, ville, pays) VALUES(:nom, :prenom, :email, :tel, :mdp, :avatar, :age, :sexe, :etat_civil, :statut, :adresse, :code_postal, :ville, :pays) ");
