...
<?php
	...
	if($_POST){
		...
		$titre_image = $_POST['titre_img'];
		$percent_circle = $_POST['percent_circle'];
		$competence = $_POST['competence'];

		$update = $bdd->query("UPDATE competences SET competence = '$competence', titre_img = '$titre_image', percent_title = '$percent_title', percent_circle = '$percent_circle' WHERE id_competence = '$id_competence'  ");
...
<form id="formulaire" method="post">
		...
		<input class="competence" type="text" name="titre_img" value="<?= $ligne_c['titre_img'] ?>"><br>
